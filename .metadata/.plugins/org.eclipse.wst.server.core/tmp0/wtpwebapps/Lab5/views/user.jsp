	...
	<div class="container col-8 pt-2">
		<div class="border rounded bg-light pl-4 pr-4 p-3">
			<div class="row p-2 pl-3 pt-3 bg-danger text-white rounded">
				<h2 class="mx-auto">LIST USERS</h2>
			</div>
			<div class="row p-2">
				<div class="col">
				...
				<div class="col">
					<form action="user" method="post">
						<div class="form-group">
							<label>User ID:</label> <input type="text" class="form-control" name="userId" value="${user.userId}" />
						</div>
						<div class="form-group">
						...
						<div class="form-group pt-2">
							<button class="btn btn-success" formaction="user/create">Create</button>
							...
							<button class="btn btn-dark" formaction="user/reset">Reset</button>
						</div>
					</form>
				</div>
			</div>
			<div class="row pt-0 pl-3 pr-3">
				<table class="table border border-dark">
					<thead class="thead-dark font-weight-bold bg-success text-dark">
						<tr>
							<td>User ID</td>
							<td>Password</td>
							<td>Fullname</td>
					...
					<tbody>
						<c:forEach var="item" items="${users}">
							<tr>
								...
								<td><a href="user/edit?userId=${item.userId}">Edit</a> | <a href="user/delete?userId=${item.userId}">Delete</a></td>
							</tr>
						</c:forEach>
					<tbody>
				</table>
